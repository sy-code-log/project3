...
3. 새 컬럼 생성
- 각 숙소에서부터 가장 가까운 대중교통까지 거리 컬럼 생성 : `walk_subway(m)`, `walk_bus(m)`, `car_airport(m)`
<br>
...
|-----------------------|------------|----------|--------------|------------|-----------|
| 초기 모델 - Train     | 55.8042    | 23.82%   | 54539.5008   | 233.5369   | 0.7006    |
| 초기 모델 - Test      | 70.595     | 28.20%   | 97288.4228   | 311.9109   | 0.2826 |
| 최종 모델 - Train     | **30.9339**    | **20.13%**   | 2104.7686    | 45.8778    | 0.7891    |
| 최종 모델 - Test      | **36.8443**    | **24.52%**   | 2887.8478    | 53.7387    | 0.7145 |
<br>
...
- 개발 : https://project3-airbnb-price-predict-service.streamlit.app/
